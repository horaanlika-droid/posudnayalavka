...
export const icons = {
  ...
  gear: svg('<circle cx="12" cy="12" r="3.1"/><path d="M12 2.8v2.7M12 18.5v2.7M2.8 12h2.7M18.5 12h2.7M5.5 5.5l1.9 1.9M16.6 16.6l1.9 1.9M18.5 5.5l-1.9 1.9M7.4 16.6l-1.9 1.9"/>'),
  tag: svg('<path d="M4 4h7l9 9-7 7-9-9z"/><circle cx="9" cy="9" r="1.5"/>'),
  photo: svg('<rect x="3.5" y="5" width="17" height="14" rx="2.5"/><circle cx="9" cy="10" r="1.6"/><path d="m5 17 4.5-4.5 3 3 2.5-2.5L19 17"/>'),
  store: svg('<path d="M4 9.5 5.5 4h13L20 9.5M4 9.5h16M4 9.5v9a1.5 1.5 0 0 0 1.5 1.5h13A1.5 1.5 0 0 0 20 18.5v-9"/><path d="M9.5 20v-5h5v5"/>'),
  chart: svg('<path d="M4 20V4M4 20h16"/><path d="M8.5 16v-5M12.5 16V8M16.5 16v-3"/>'),
  users: svg('<circle cx="9" cy="8.5" r="3.2"/><path d="M3 19.5c.6-3.2 3-5 6-5s5.4 1.8 6 5"/><circle cx="16.8" cy="9.5" r="2.5"/><path d="M16.5 14.6c2.1.4 3.7 1.9 4.2 4"/>'),
  edit: svg('<path d="M4 20l1-4L16.5 4.5a2.1 2.1 0 0 1 3 3L8 19z"/><path d="M14.5 6.5l3 3"/>'),
};
